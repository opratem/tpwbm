...
export default function WomenMinistryPage() {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-purple-500 via-pink-500 to-rose-500 text-white py-12 md:py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            <div className="flex justify-center mb-6 animate-in fade-in slide-in-from-top duration-1000 delay-200">
              <Flower className="h-12 sm:h-16 w-12 sm:w-16 text-purple-200 drop-shadow-lg" />
            </div>
            <h1 className="mobile-text-3xl font-bold mb-4 md:mb-6 bg-gradient-to-r from-white via-purple-100 to-white bg-clip-text text-transparent drop-shadow-2xl animate-in fade-in slide-in-from-top duration-1000 delay-400">
              Women's Ministry
            </h1>
            <p className="mobile-text-lg text-purple-100 max-w-3xl mx-auto mb-6 md:mb-8 font-light leading-relaxed drop-shadow-lg animate-in fade-in slide-in-from-top duration-1000 delay-600">
              Empowering women to walk in their God-given purpose through biblical teaching,
              encouraging fellowship, and authentic sisterhood that reflects Christ's love
              in every season of life.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom duration-1000 delay-800">
              <div className="flex items-center text-purple-100 drop-shadow-md transform hover:scale-105 transition-all duration-300">
                <Clock className="h-4 sm:h-5 w-4 sm:w-5 mr-2" />
                <span className="font-medium text-sm sm:text-base">Tuesdays 10:00 AM - 11:30 AM</span>
              </div>
              <div className="flex items-center text-purple-100 drop-shadow-md transform hover:scale-105 transition-all duration-300">
                <Users className="h-4 sm:h-5 w-4 sm:w-5 mr-2" />
                <span className="font-medium text-sm sm:text-base">All Women Welcome</span>
              </div>
            </div>
          </div>
        </section>
