      ...
      <div className="min-h-screen bg-gradient-to-b from-white via-white to-gray-50">
        ...
        <section className="relative text-white py-8 overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src={getCloudinaryImageUrl(churchImages.children.children1, {
                width: 1920,
                height: 1080,
                crop: 'fill',
                quality: 'auto',
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="mobile-text-lg text-white max-w-3xl mx-auto mb-6 md:mb-8 font-light leading-relaxed drop-shadow-md animate-in fade-in slide-in-from-top duration-1000 delay-600">
              Nurturing young hearts and minds in God's love through engaging Bible lessons,
              worship, and fellowship in a safe and caring environment.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom duration-1000 delay-800">
              <div className="flex items-center text-white drop-shadow-md transform hover:scale-105 transition-all duration-300">
                <Clock className="h-5 w-5 mr-2" />
                <span>Sundays 9:00 AM - 11:30 AM</span>
              </div>
              <div className="flex items-center text-white drop-shadow-md">
                <Users className="h-5 w-5 mr-2" />
                <span>Ages 2-12 Welcome</span>
              </div>
            </div>
            {isLoading && (
                <div className="flex items-center justify-center gap-2 text-white drop-shadow-md mt-4">
                  <Loader2 className="h-4 w-4 animate-spin" />
                  <span className="text-sm">Loading children's ministry photos...</span>
                </div>
            )}
          </div>
        </section>
