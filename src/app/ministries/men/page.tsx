...
export default function MenMinistryPage() {
  ...
  return (
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
        {/* Hero Section */}
        <section className="bg-gradient-to-r from-blue-600 via-indigo-600 to-slate-600 text-white py-12 md:py-16 relative overflow-hidden">
          ...
          <div className="container mx-auto px-4 text-center relative z-10">
            ...
            <p className="text-lg sm:text-xl text-blue-100 max-w-3xl mx-auto mb-6 md:mb-8 font-medium leading-relaxed drop-shadow-lg animate-in fade-in slide-in-from-top duration-1000 delay-600">
              Equipping men to be godly leaders, faithful husbands, loving fathers,
              and servants of Christ who make a lasting impact in their families,
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center animate-in fade-in slide-in-from-bottom duration-1000 delay-800">
              <div className="flex items-center text-blue-100 drop-shadow-md transform hover:scale-105 transition-all duration-300">
                <Clock className="h-4 sm:h-5 w-4 sm:w-5 mr-2" />
                <span className="font-medium text-sm sm:text-base">Saturdays 7:00 AM - 8:30 AM</span>
              </div>
              <div className="flex items-center text-blue-100 drop-shadow-md transform hover:scale-105 transition-all duration-300">
                <Users className="h-4 sm:h-5 w-4 sm:w-5 mr-2" />
                <span className="font-medium text-sm sm:text-base">All Ages Welcome</span>
              </div>
            </div>
          </div>
        </section>
