...
export default function ContactPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative w-full mobile-section-spacing bg-gradient-to-br from-church-primary-dark via-church-primary to-church-secondary text-white overflow-hidden min-h-[40vh] sm:min-h-[45vh] md:min-h-[50vh]">
        {/* Background Image with Blur */}
        <div
          className="absolute inset-0 bg-cover bg-no-repeat"
          style={{
            backgroundImage: "url('https://images.squarespace-cdn.com/content/v1/66e074a8a254c742976157fc/6f0e011f-4573-4ab4-8c4c-25c0c9fb0d9c/ContactUs-2024.jpg')",
        ...
        <div className="container mobile-container relative z-10 h-full flex items-center justify-center">
          <div className="flex flex-col items-center justify-center text-center mobile-space-y-6 w-full px-4 sm:px-0">
            <div className="mobile-space-y-4">
              <MessageCircle className="h-10 w-10 sm:h-12 sm:w-12 md:h-16 md:w-16 text-white mx-auto drop-shadow-lg animate-in fade-in slide-in-from-top duration-1000 delay-100" />
              ...
              <p className="mx-auto max-w-[600px] text-white mobile-text-base font-medium leading-relaxed drop-shadow-lg animate-in fade-in slide-in-from-top duration-1000 delay-500">
