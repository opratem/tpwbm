...
export default function GalleryPage() {
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-4 mb-8">
            ...
            <div className="flex items-center gap-2">
              <Images className="h-5 w-5 text-[hsl(218,31%,18%)] dark:text-[hsl(218,31%,70%)]" />
  ...
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative w-full py-8 md:py-12 bg-gradient-to-br from-[hsl(218,31%,18%)] via-[hsl(218,28%,15%)] to-[hsl(218,31%,12%)] text-white overflow-hidden">
        {/* Background Image with Blur */}
        <div
          className="absolute inset-0 bg-cover bg-no-repeat"
          style={{
            backgroundImage: "url('/images/gallery/Church1.jpg')",
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[hsl(218,31%,18%)]/50 via-[hsl(218,31%,20%)]/30 to-[hsl(45,56%,35%)]/20" />
        <div className="container px-4 md:px-6 relative z-10">
          <div className="text-center space-y-8">
            <h1 className="mobile-text-3xl font-bold tracking-tight text-white animate-in fade-in-50 slide-in-from-bottom-4 duration-1000" style={{color: 'white'}}>
              Church Gallery
            </h1>
            <p className="mobile-text-lg text-gray-200 max-w-3xl mx-auto animate-in fade-in-50 slide-in-from-bottom-4 duration-1000 delay-200">
              Capturing precious moments of faith, fellowship, and worship in our church community
            </p>
          </div>
        </div>
      </section>
