    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative w-full mobile-section-spacing bg-gradient-to-br from-church-primary-dark via-church-primary to-church-secondary text-white overflow-hidden">
        ...
        <div className="container mobile-container relative z-10">
          <div className="flex flex-col items-center justify-center mobile-space-y-6 text-center">
            <div className="mobile-space-y-4">
              <h1 className="mobile-text-3xl font-bold tracking-tighter text-white drop-shadow-2xl">
                About Our Church
              </h1>
              <p className="mx-auto max-w-[800px] text-white mobile-text-lg font-light leading-relaxed drop-shadow-lg px-4 sm:px-0">
                Discover our rich history, unwavering mission, and the values that have guided us since 1994.
              </p>
            </div>
            <div className="flex items-center gap-3 sm:gap-4 mt-4 sm:mt-6 md:mt-8">
