...
export function ScrollToTop() {
    ...
    return (
        <button
            onClick={scrollToTop}
            className={cn(
                'fixed bottom-8 right-8 z-50 p-3 rounded-full bg-church-primary text-white shadow-lg hover:bg-church-primary-dark transition-all duration-300 hover:scale-110',
